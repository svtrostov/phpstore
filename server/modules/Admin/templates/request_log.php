		...
		<div class="contentwrapper">
			<div class="contentareafull">
				...
				<div class="tool_area">
					...
					<div class="left">
						<input type="text" value="" id="filter_ip" placeholder="IP адрес" style="width:100px;"/>
					</div>
					<div class="left">
						<input type="text" value="" id="filter_url" placeholder="URL содержит" style="width:100px;"/>
					</div>
					<div class="left">
						<input type="text" value="" id="filter_code" placeholder="Код" style="width:60px;"/>
					</div>
					<div class="left">

	...
	<div id="mainWrapper">
		<div id="wrapper">
			...
			<div class="centralArea">
				...
				<br><div id="bg_catalog_1">Восстановление пароля</div>
				<br><br>
				<font style="font-size:12px;">На указанный Вами адрес электронной почты было выслано письмо с регистрационными данными.</font>
				<br>
			</div>

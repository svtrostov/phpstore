			...
			<div class="centralArea">
				...
				<div class="orderClientInfo">
					<table class="utable">
						<tr>
							<td class="param">&nbsp;</td>
							<td class="value">Данные для входа в кабинет клиента:</td>
						</tr>
						<tr>
							<td class="param">Логин:</td>
							<td class="value"><input type="text" class="input" value="{%client_login%}" style="width:300px"></td>
						</tr>
						<tr>
							<td class="param">Пароль:</td>
							<td class="value"><input type="text" class="input" value="{%client_password%}" style="width:300px"></td>
						</tr>
						<tr>
							<td class="param">&nbsp;</td>
							<td class="value"><br>Сменить пароль Вы можете в личном кабинете в разделе персональных данных.</td>
						</tr>
					</table>
				</div>
			</div>

		...
		<div id="wrapper">
			...
			<div class="centralArea">
				...
				<div class="siteMiddleDivContent">
					<br>
					<div id="bg_catalog_1">Контакты</div>
					...
					<div style="padding:5px"><div class="contacts">
						<table><tbody>
							<tr><td colspan="2"><h2>ИП Долгов Александр Александрович</h2></td></tr>
							<tr><td class="param">ОГРНИП:</td><td class="value">306616613800012</td></tr>
							<tr><td class="param">Телефон/факс:</td><td class="value">+7 (863) 309-00-89</td></tr>
							<tr><td class="param">E-Mail:</td><td class="value">info@dtbox.ru</td></tr>
							<tr><td class="param">Адрес:</td><td class="value">г.Ростов-на-Дону, Лермонтовская 102 оф.6</td></tr>
							<tr><td class="param">График работы:</td><td class="value">понедельник-пятница с 10-00 до 18-00</td></tr>
							<tr><td class="param">Схема проезда:</td><td><script type="text/javascript" charset="utf-8" src="//api-maps.yandex.ru/services/constructor/1.0/js/?sid=KjnUkVTqQIH7gyVCQ706g7FytsGsRQUh&amp;width=600&amp;height=450"></script></td></tr></tbody>
						</table>
					</div></div>
				</div>

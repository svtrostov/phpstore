...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	...
	<div id="mainWrapper">
		<div id="wrapper">
			...
			<div class="centralArea"><div class="siteMiddleDivContent">

				<br><div id="bg_catalog_1">Связь с менеджерами</div>
				<div class="lightBox"><div class="title">Задать вопрос менеджеру</div></div>
				<div class="userMessageForm"><br>
					<table style="width:100%;">
						<tr>
						<td style="width:100%;height:100px;">
							<form method="post" id="messageform">
							<b>Тема сообщения</b><br>
							<input type="text" class="input" style="width:100%;" name="subject" id="subject"><br><br>
							<b>Текст сообщения:</b><br>
							<textarea style="width:100%;height:100px;" name="message" id="message"></textarea>
							<div>
								<div class="light_button fl_right" style="width:200px;" onclick="sendMessage();"><span>Отправить сообщение</span></div>
							</div>
							</form>
						</td></tr>
					</table>
				...
				<script>
					var messageformvalidator = new jsValidator("messageform");
					messageformvalidator.required("subject").required("message");
					function sendMessage(){
						if(!messageformvalidator.validate())return false;
						$("messageform").submit();
					}
				</script>
				<br>
				<div class="darkBox"><div class="title">История сообщений</div></div>
				{%FN::mc_userMessages%}
			</div></div>

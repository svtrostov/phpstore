	...
	<div id="mainWrapper">
		<div id="wrapper">
			...
			<div class="centralArea">
				...
				<br><div id="bg_catalog_1">Спасибо за рагистрацию в интернет-магазине DTBox.ru!</div>
				<br><h3>Приятных Вам и выгодных покупок!</h3><br><br>
				<font style="font-size:12px;">Также, на указанный Вами во время регистрации адрес электронной почты было выслано письмо с регистрационными данными.</font>
				<br>
			</div>
